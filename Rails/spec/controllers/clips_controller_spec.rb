  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved clip as @clip" do
        ...
        post :create, {:clip => { "name" => "invalid value" }}, valid_session
        assigns(:clip).should be_a_new(Clip)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested clip" do
        ...
        Clip.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => clip.to_param, :clip => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the clip as @clip" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Clip.any_instance.stub(:save).and_return(false)
        put :update, {:id => clip.to_param, :clip => { "name" => "invalid value" }}, valid_session
        assigns(:clip).should eq(clip)
      end
